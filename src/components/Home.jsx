...
export default function Home() {
  return (
    <div className="mt-6 md:w-[44rem] lg:w-[54rem] py-12 px-6 md:py-16 md:px-8 lg:py-24 lg:px-16">
      ...
      <p className="mt-8 text-md lg:text-lg text-[#676362] lg:w-[42rem] leading-6">
